...
public class Question3_passingCars {
	public static void main (String[] args) {
		...
		/**
		 * Q3 => We receive an array filled with 0's and 1's which represent cars
	...
	public static int passingCars(int[] a) {
		...
		// For every 0 we have the number of pairs equivilent to the number of 1's after it
