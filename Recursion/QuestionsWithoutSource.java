...
class Cls {
	public static void main (String[] args) {
		...
		//Q4 => We get an array which represents the prices of every piece of a stick by length
		// IE: Index 2 is 2 cm and the price is 3
		// We need to find the maximum price possible for a given stick
